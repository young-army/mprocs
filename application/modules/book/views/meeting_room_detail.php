                ...
                <div class="box-body">
                  <table id="operational_car" class="table table-bordered table-hover" style="font-size:9pt !important">
					...
					<tr>
						...
						<td><?php echo $row->start_book;?></td>
						<td><?php echo $row->end_book;?></td>
						<td><?php echo $row->contingent;?> Persons</td>
				  ...
				  <a href="<?php echo base_url();?>book/meeting_room" class="btn btn-primary" class="btn btn-success"><i class="fa fa-angle-double-left"></i>&nbsp;&nbsp;&nbsp;Back</a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
              </div><!-- /.box -->
              </div><!-- /.box -->
