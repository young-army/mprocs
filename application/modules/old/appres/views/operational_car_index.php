                ...
                <div class="box-body"><br>
                  <table id="operational_car" class="table table-bordered table-hover" style="font-size:9pt !important">
					...
					<tr>
						<td><?php echo $no;?></td>
						<td>
						Vehicle Number :<?php echo $row->v_num;?><br>
						Brand/Type : <?php echo $row->brand."/".$row->type;?><br>
						Color : <?php echo $row->color;?><br>
						Max Capacity : <?php echo $row->capacity;?> Persons
						</td>
						<td><?php echo $row->book_date;?></td>
						<td><?php echo $row->end_time_est;?></td>
						...
						<td>
						<?php if($row->status==0){?>
						<a href="<?php echo base_url();?>appres/operational_car/approve/<?php echo $row->id;?>" onclick="return confirm('Are You Sure ?')" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> Approve</a>
						<?php }else{
							echo ' ';
						} ?>
						</td>
