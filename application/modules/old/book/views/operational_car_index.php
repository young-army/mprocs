...
$(document).ready(function(){
	$('#submit').click(function(){
		$.post('<?php echo base_url();?>book/operational_car/save',$('#formData').serialize(),function(response){
			if(response=='S'){
				alert('Success');
...
function detail(code){
	if(num==0){
		...
		document.location.href="<?php echo base_url();?>detail/operational_car/"+code;
	}
}
</script>
<div class="row">
                  ...
                  <table id="meetroom_tbl" class="table" style="font-size:9pt !important">
					...
					<?php $no=1; foreach($data as $row){?>
						...
						<td  style="text-align:center;padding:0px;width:20%">
							<div style="margin:2px;padding:20px 0px;height:100%;border:1px solid gray;border-radius:5px" class="box-book"  onclick="check('<?php echo $no;?>','<?php echo $row->v_num;?>')" id="box-book<?php echo $no;?>">
							<i class="fa fa-truck" style="font-size:30pt"></i><br>
							<input type="radio" name="room" class="room" style="display:none" value="<?php echo $row->v_num;?>" id="radio<?php echo $no;?>">
							<h5 style="font-family:Khand"><?php echo $row->brand." ".$row->type;?></h5>
							<h5 style="font-family:Khand">Color : <?php Echo $row->color." / ";?>Capacity : <?php echo $row->capacity;?> Persons<br>
							Vehicle Number : <?php echo $row->v_num;?>
							</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Operational Car Booking Form</h4>
            </div>
				...
				<form id="formData" method="post" style="font-size:9pt !important">
					<div class="form-group">
					  ...
					  <input type="text" class="form-control form-input" id="v_num" name="v_num">
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
                      ...
                      <input type="text" class="form-control form-input" id="dest" name="dest" placeholder="Destination">
                    </div>
					<div class="form-group">
                      <label for="exampleInputEmail1">Driver</label>
                      <input type="text" class="form-control form-input" id="driver" name="driver" placeholder="Driver">
                    </div>
				</form>
                </div> 
