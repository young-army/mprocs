...
<div class="row">
            <div class="col-xs-12">
              <div class="box">
				...
				<button class="btn btn-primary" onclick="cart()">My Cart&nbsp;&nbsp;&nbsp;<sup><span class="label label-danger" id="countCart"></span></sup></button><br><br>
                 <table id="operational_car" class="table table-bordered table-hover" style="font-size:9pt !important">
					...
					<tbody>
						...
						<tr>
							...
							<td>
							<button class="btn btn-sm btn-primary" onclick="order('<?php echo $row->item_code;?>','<?php echo $row->item_name;?>')"><i class="fa fa-shopping-cart"></i>&nbsp;&nbsp;&nbsp;Order</button>
							</td>
						</tr>
						<?php $no++; } ?>
					</tbody>
