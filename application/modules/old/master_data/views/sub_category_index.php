...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>master_data/sub_category/save',$('#formData').serialize(),function(){
        sub_category.fnClearTable();
        $.getJSON('<?php echo base_url();?>master_data/sub_category/getData',function(data){
...
function del(id_sub_category){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>master_data/sub_category/delete/'+id_sub_category,function(){
      $.getJSON('<?php echo base_url();?>master_data/sub_category/getData',function(data){
        var sub_category = $('#sub_category').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
...
function edit(id_sub_category){
  $.getJSON('<?php echo base_url();?>master_data/sub_category/getDetail/'+id_sub_category,function(data){
