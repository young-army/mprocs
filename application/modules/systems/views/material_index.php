...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>systems/material/save',$('#formData').serialize(),function(){
        material.fnClearTable();
      /*  $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
          company.fnAddData(data);
          $('.form-input').val('');
        });*/
        window.location.href = "<?php echo site_url('/systems/material'); ?>";   
    }); 
  });
...
function del(id_material){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>systems/material/delete/'+id_material,function(){
      $.getJSON('<?php echo base_url();?>systems/material/getData',function(data){
        var material = $('#material').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
            "bFilter": false,
...
function edit(id_material){
  $.getJSON('<?php echo base_url();?>systems/material/getDetail/'+id_material,function(data){
