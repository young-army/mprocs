...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>systems/registration_status/save',$('#formData').serialize(),function(){
      ...
      /*  $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
        ...
        window.location.href = "<?php echo site_url('/systems/registration_status'); ?>";   
    }); 
  });
...
function del(id_registration_status){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>systems/registration_status/delete/'+id_registration_status,function(){
      $.getJSON('<?php echo base_url();?>systems/registration_status/getData',function(data){
        var registration_status = $('#registration_status').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
            "bFilter": false,
...
function edit(id_registration_status){
  $.getJSON('<?php echo base_url();?>systems/registration_status/getDetail/'+id_registration_status,function(data){
