...
/*  var vendor_redlist = $('#vendor_redlist').dataTable({
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>vendor/vendor_redlist/save',$('#formData').serialize(),function(){
        //vendor_redlist.fnClearTable();
      /*  $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
          company.fnAddData(data);
          $('.form-input').val('');
        });*/
        window.location.href = "<?php echo site_url('/vendor/vendor_redlist'); ?>";   
    }); 
  });
...
function del(id_vendor_redlist){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>vendor/vendor_redlist/delete/'+id_vendor_redlist,function(){
...
function edit(id_vendor_redlist){
  $.getJSON('<?php echo base_url();?>vendor/vendor_redlist/getDetail/'+id_vendor_redlist,function(data){
...
<div class="row">
        ...
        <a data-toggle="modal" href="#myModal" class="btn btn-success">Add New Vendor Redlist</a><br>
          ...
          <tr>
            ...
            <a href="<?php echo base_url();?>vendor/vendor_redlist/approve/<?php echo $row->id_vendor_redlist;?>" onclick="return confirm('Are You Sure ?')" class="btn btn-primary btn-xs"><i class="fa fa-check"></i> Approve</a>
            <?php }else{
              echo ' ';
            } ?>
