...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>master_data/department/save',$('#formData').serialize(),function(){
        department.fnClearTable();
      /*  $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
          company.fnAddData(data);
          $('.form-input').val('');
        });*/
        window.location.href = "<?php echo site_url('/master_data/department'); ?>";   
    }); 
  });
...
function del(id_department){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>master_data/department/delete/'+id_department,function(){
      $.getJSON('<?php echo base_url();?>master_data/department/getData',function(data){
        var department = $('#department').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
            "bFilter": false,
...
function edit(id_department){
  $.getJSON('<?php echo base_url();?>master_data/department/getDetail/'+id_department,function(data){
