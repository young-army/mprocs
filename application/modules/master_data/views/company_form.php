...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>master_data/company/save',$('#formData').serialize(),function(){
        company.fnClearTable();
      /*  $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
          company.fnAddData(data);
          $('.form-input').val('');
        });*/
        window.location.href = "<?php echo site_url('/master_data/company'); ?>";   
    }); 
  });
...
function del(id_company){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>master_data/company/delete/'+id_company,function(){
      $.getJSON('<?php echo base_url();?>master_data/company/getData',function(data){
        var company = $('#company').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
...
function edit(id_company){
  $.getJSON('<?php echo base_url();?>master_data/company/getDetail/'+id_company,function(data){
