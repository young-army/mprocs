...
$(document).ready(function(){
  ...
  $('#submit').click(function(){
    $.post('<?php echo base_url();?>master_data/category/save',$('#formData').serialize(),function(){
        category.fnClearTable();
        $.getJSON('<?php echo base_url();?>master_data/category/getData',function(data){
...
function del(id_category){
  ...
  if(con==true){
    $.post('<?php echo base_url();?>master_data/category/delete/'+id_category,function(){
      $.getJSON('<?php echo base_url();?>master_data/category/getData',function(data){
        var category = $('#category').dataTable({
            "bPaginate": true,
            "bLengthChange": false,
...
function edit(id_category){
  $.getJSON('<?php echo base_url();?>master_data/category/getDetail/'+id_category,function(data){
