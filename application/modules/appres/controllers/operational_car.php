...
class Operational_car extends MX_Controller {
	...
	public function index(){
		...
		$data['data']			= $this->db->query("select a.*,b.brand,b.type,b.capacity,b.color from h_book_operational_car a join operational_car b on a.v_num = b.v_num")->result();
	...
	function approve($id){
		$this->db->query("update h_book_operational_car set status = '1' where id = '$id'");
		redirect('appres/operational_car');
	}
