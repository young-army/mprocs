...
<script src="<?php echo base_url();?>assets/fixtable/tableHeadFixer.js"></script>
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>assets/excel-xp.css"/>
<script>
			a = jQuery.noConflict();
			a(document).ready(function() {
				a("#fixTable").tableHeadFixer(); 
			});
		</script>
<div class="row">
            <div class="col-xs-12">
              <div class="box">
                <div class="box-body">
				  <form method="post">
				   ...
				   <div style="width:100%;overflow:auto;height:100px;border-right:1px solid #C0C0C0;border-bottom:1px solid #C0C0C0">
                  <table id="fixTable" border="1" class="ExcelTableXP">
						<thead>
						<tr>
						<th class="heading" style="width:27px;border:1px solid gray !important">&nbsp;</th>
						<th>Material</th>
						<th>Short Text</th>
						<th>Quantity</th>
						<th>Account</th>
						...
						<tbody>
						<tr>
							<th style="padding:0px 8px;w">1</th>
